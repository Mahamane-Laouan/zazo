...
//        }
    ...
    public static function get_full_url($path, $data, $type = 'public', $placeholder = null)
{
    $place_holders = [
    ...
    try {
        ...
        // S3 non configuré ou erreur, on continue
    }
    ...
    // API request: retourner null si pas de fichier
    if (request()->is('api/*')) {
        return null;
    }

    // Placeholder
    if ($placeholder && array_key_exists($placeholder, $place_holders)) {
